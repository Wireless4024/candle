...
CONV1D_OP(uint16_t, uint16_t, conv1d_u16)
...
CONV2D_OP(uint16_t, uint16_t, conv2d_u16)
...
CONVT1D_OP(uint16_t, uint16_t, conv_transpose1d_u16)
...
CONVT2D_OP(uint16_t, uint16_t, conv_transpose2d_u16)
...
AVG_POOL2D_OP(uint16_t, uint16_t, avg_pool2d_u16)
...
MAX_POOL2D_OP(uint16_t, max_pool2d_u16)
