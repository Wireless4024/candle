...
impl ToDTypeHelper for f16 {
    ...
    #[inline(always)]
    fn into_f8e4m3(self) -> F8E4M3 {
        F8E4M3::from_f32(self.to_f32())
    }
}

impl ToDTypeHelper for F8E4M3 {
    fp_to_int_cast!();
    #[inline(always)]
    fn into_f16(self) -> f16 {
...
pub fn unary_convert<T: ToDTypeHelper>(vs: &[T], layout: &Layout, dtype: DType) -> CpuStorage {
    match dtype {
        ...
        DType::F8E4M3 => CpuStorage::F8E4M3(unary_map(vs, layout, |v| v.into_f8e4m3())),
    }
}
