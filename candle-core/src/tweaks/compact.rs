...
impl<'de> Deserialize<'de> for ArcStr {
    ...
    where
        D: Deserializer<'de>,
    {
        let str = serde::__private::de::borrow_cow_str::<_, Cow<str>>(deserializer)?;
...
impl ToArcString for String {
    #[inline(always)]
    fn to_string(&self) -> ArcStr {
        ArcStr::from(self.as_str())
    }
}
impl ToArcString for Box<str> {
    #[inline(always)]
    fn to_string(&self) -> ArcStr {
       ToArcString::to_string(&Arc::<str>::from(self.clone()))
    }
}
...
impl ArcStr {
    ...
    fn new_copy(str: &str) -> Self {
        ...
        ArcStr { inner: Some(Arc::from(ToString::to_string(str).into_boxed_str())) }
    }
    ...
    pub fn as_str(&self) -> &str {
        self.inner.as_ref().map(|s| &**s).unwrap_or("")
    }
...
impl StrWriter {
    ...
    fn into_arc_str(self) -> ArcStr {
        ...
        // ArcStr { inner }
        ArcStr { inner: Some(Arc::from(self.inner.into_boxed_str())) }
    }
}
